...
#define OUT_BUFFER_SECOND_INDEX 18 
#define OUT_BUFFER_MINUTE_INDEX 15
#define OUT_BUFFER_HOUR_INDEX 12
#define OUT_BUFFER_DATE_INDEX 4
#define OUT_BUFFER_MONTH_INDEX 1
#define OUT_BUFFER_YEAR_INDEX  9
...
void Ds1302SetDateTime(const Ds1302DateTime *dateTime){
	...
	PORTA.DIRSET.reg = DS1302_ENABLE_PINMASK | DS1302_DATA_PINMASK | DS1302_CLOCK_PINMASK;

...
#define NUM_LED_FLASHES_NO_SD		1
#define NUM_LED_FLASHES_CONFIG		3
#define NUM_LED_FLASHES_TIME_INIT	4
#define NUM_LED_FLASHES_GENERIC		5

#define LED_FLASH_TIME_SUCCESS		100
